...
For using the live data to build the Knowledge Tree
...
There is a `main.py` script that generates RDF files (in XML format)
for e.g. country individuals, developer role individuals and age ranges.
Which can easily be appended to the ontology file to have individuals defined in it.
...
These are the main SPARQL queries we have been developing for the app.
...
### Query 2: [Location] As a _(profession)_ I live in _(country)_ and I can program in _(programming language)_ and I want at least _(amount)_ USD per year. Should I stay our should I go?  
